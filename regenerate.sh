...
mkdir -p ${WORKDIR}/out/github.com/seacomandor/grpc-go/balancer/rls/internal/proto/grpc_lookup_v1
mv ${WORKDIR}/out/github.com/seacomandor/grpc-go/lookup/grpc_lookup_v1/* ${WORKDIR}/out/github.com/seacomandor/grpc-go/balancer/rls/internal/proto/grpc_lookup_v1
...
rm ${WORKDIR}/out/github.com/seacomandor/grpc-go/reflection/grpc_testingv3/*.pb.go
...
cp -R ${WORKDIR}/out/github.com/seacomandor/grpc-go/* .
